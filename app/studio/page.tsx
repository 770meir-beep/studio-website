...
const rooms = [
  {
    ...
    imageAlt: "Main recording studio with mixing console",
    description:
  ...
  },
  {
    ...
    imageAlt: "Intimate recording room",
    description:
  ...
  },
  {
    ...
    imageAlt: "Mastering studio setup",
    description:
...
const gear = [
  ...
  { category: "Preamps", items: ["Neve 1073 (×16)", "API 512c (×8)", "Chandler REDD.47 (×4)", "Universal Audio 610"] },
  { category: "Compressors", items: ["Neve 33609", "SSL G-Bus Compressor", "Urei 1176 (×4)", "Teletronix LA-2A (×2)", "Manley Vari-Mu"] },
  { category: "EQ", items: ["Neve 1081 (×8)", "Pultec EQP-1A (×4)", "Sontec MES 432C", "Dangerous Bax EQ"] },
  { category: "Microphones", items: ["Neumann U87 (×6)", "AKG C12", "Sony C800G", "Shure SM7B (×8)", "Royer R-121 (×4)", "80+ mic locker"] },
  { category: "Monitoring", items: ["Augspurger Custom Mains", "Genelec 8351 (×4)", "Yamaha NS10M (×2)", "Avantone MixCubes"] },
];
      ...
      <section className="relative pt-40 pb-24 px-6 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-[#080608]/85" />
          <div
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[#C98BA0] text-[11px] tracking-[0.4em] uppercase">The Studio</span>
          </div>
          <h1
          ...
          <p className="text-[#A89298] text-xl leading-relaxed max-w-2xl">
            ...
            environment designed to inspire at 1402 Union St, Brooklyn.
          </p>
        </div>
      </section>
          ...
          {rooms.map((room, index) => (
            ...
            >
              ...
              <div className="relative h-64 md:h-80 w-full overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#080608] via-transparent to-transparent" />
              ...
              <div className="p-10 md:p-16 grid md:grid-cols-2 gap-12">
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    <div className="h-px w-6 bg-[#C98BA0]/40" />
                ...
                <div>
                  ...
                  <h4 className="text-[11px] text-[#C98BA0] tracking-[0.3em] uppercase mb-6">
                    Room Specifications
                  </h4>
                  <ul className="space-y-3">
                    {room.specs.map((spec) => (
                      <li key={spec} className="flex items-start gap-3 text-sm text-[#A89298]">
                        <span className="text-[#C98BA0] shrink-0">—</span>
                        {spec}
                      </li>
                    ))}
                  </ul>
      ...
      <section className="py-32 px-6 bg-[#060406]">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-4 mb-4">
            <div className="h-px w-8 bg-[#C98BA0]" />
            <span className="text-[#C98BA0] text-[11px] tracking-[0.4em] uppercase">Equipment</span>
          </div>
          <h2
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-[#201820]">
            {gear.map((section) => (
              ...
              >
                <div className="h-px w-8 bg-[#C98BA0]/40 mb-5" />
                ...
                <ul className="space-y-2">
                  {section.items.map((item) => (
                    <li key={item} className="text-sm text-[#A89298] flex items-center gap-2">
                      <span className="w-1 h-1 rounded-full bg-[#C98BA0]/40 shrink-0" />
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-[#A89298] text-sm">
              1402 Union St, Brooklyn, NY · Tours available by appointment.
            </p>
          </div>
